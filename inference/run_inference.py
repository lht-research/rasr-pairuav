...
the range-aware scale-recovery configuration and the PairUAV benchmark-specific
distance head, transforms the frozen heading column, and performs row-local
self-pair zeroing.
"""
